...
//   Some hacks: Achim Friedland (achim@graph-database.org)
//
...
namespace Mono
{
	...
	public class Driver
    {
		...
		public static int HandleExtraArguments (string [] args, int pos)
		{
	...
	public class CSharpShell
    {
		...
		public CSharpShell(Evaluator evaluator, String ShellName = "CSharpShell")
		{
		...
		void SetupConsole ()
		{
            ...
            _Editor = new LineEditor(ShellName, 300);
		...
		String GetLine(Boolean primary)
		{
            ...
            var prompt = primary ? ShellName+"> " : InteractiveBase.ContinuationPrompt;
...
//			Report.Stderr = Console.Out;
		...
		public virtual int Run(String[] startup_files = null)
		{
            
            if (startup_files == null)
                startup_files = new String[0];
